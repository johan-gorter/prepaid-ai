...
const nl: MessageSchema = {
  ...
  about: {
    ...
    dataRetention:
      "Geüploade afbeeldingen en gegenereerde resultaten worden minimaal {min} en maximaal {max} bewaard vanaf de uploaddatum. Na de bewaarperiode kunnen afbeeldingen permanent worden verwijderd. Je kunt je afbeeldingen op elk moment verwijderen via de detailpagina van je make-over, of je hele account verwijderen via de pagina {account}.",
