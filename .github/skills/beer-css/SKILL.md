...
<div style="position: relative;">
  ...
  <menu :class="{ active: showMenu }" class="right no-wrap">
    <li>
      <a @click="action1"><i>edit</i><span>Edit</span></a>
    </li>
    <li>
      <a @click="action2"><i>delete</i><span>Delete</span></a>
    </li>
    <li class="divider"></li>
    <li>
      <a @click="action3"><i>info</i><span>About</span></a>
    </li>
  </menu>
</div>
```
...
```html
<span class="chip">Label</span> <span class="chip small">Small chip</span>
```
